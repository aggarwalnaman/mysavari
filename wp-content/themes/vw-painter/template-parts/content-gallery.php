  ...
  <div class="post-main-box">
    ...
    <div class="new-text">
      ...
      <div class="content-bttn">
        <a href="<?php echo esc_url( get_permalink() );?>" class="blogbutton-small" title="<?php esc_attr_e( 'READ MORE','vw-painter' ); ?>"><?php esc_html_e('READ MORE','vw-painter'); ?><span class="screen-reader-text"><?php esc_html_e( 'READ MORE','vw-painter' );?></span></a>
      </div>
    </div>
  </div>
</article>